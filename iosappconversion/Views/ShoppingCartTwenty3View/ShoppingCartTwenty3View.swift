...
struct ShoppingCartTwenty3View: View {
    @StateObject var shoppingCartTwenty3ViewModel = ShoppingCartTwenty3ViewModel()
                ...
                ScrollView(.vertical, showsIndicators: false) {
                    VStack(alignment: .trailing, spacing: 0) {
                        ...
                        HStack {
                            ...
                            Spacer()
                            VStack {
                                Text(StringConstants.kLblBedAssembly)
                            ...
                            .frame(width: getRelativeWidth(146.0), height: getRelativeHeight(59.0),
                                   alignment: .bottom)
...
struct ShoppingCartTwenty3View_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartTwenty3View()
    }
}
