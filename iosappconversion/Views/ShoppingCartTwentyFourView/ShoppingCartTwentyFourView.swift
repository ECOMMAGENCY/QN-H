...
struct ShoppingCartTwentyFourView: View {
    @StateObject var shoppingCartTwentyFourViewModel = ShoppingCartTwentyFourViewModel()
...
struct ShoppingCartTwentyFourView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartTwentyFourView()
    }
}
