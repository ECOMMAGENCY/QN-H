...
struct ShoppingCartFortyNineView: View {
    @StateObject var shoppingCartFortyNineViewModel = ShoppingCartFortyNineViewModel()
...
struct ShoppingCartFortyNineView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartFortyNineView()
    }
}
