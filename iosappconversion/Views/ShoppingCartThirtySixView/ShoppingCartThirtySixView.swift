...
struct ShoppingCartThirtySixView: View {
    @StateObject var shoppingCartThirtySixViewModel = ShoppingCartThirtySixViewModel()
...
struct ShoppingCartThirtySixView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartThirtySixView()
    }
}
