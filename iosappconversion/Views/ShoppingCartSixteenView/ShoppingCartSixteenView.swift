...
struct ShoppingCartSixteenView: View {
    @StateObject var shoppingCartSixteenViewModel = ShoppingCartSixteenViewModel()
                ...
                ScrollView(.vertical, showsIndicators: false) {
                    VStack(alignment: .trailing, spacing: 0) {
                        ...
                        HStack {
                            ...
                            .frame(width: getRelativeWidth(187.0), height: getRelativeHeight(52.0),
                                   alignment: .bottom)
...
struct ShoppingCartSixteenView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartSixteenView()
    }
}
