        ...
        HStack {
            ...
            VStack {
                Text(StringConstants.kMsgOutdoorFurnitu)
                    ...
                    .frame(width: getRelativeWidth(167.0), height: getRelativeHeight(25.0),
                           alignment: .leading)
            ...
            .frame(width: getRelativeWidth(167.0), height: getRelativeHeight(61.0),
                   alignment: .leading)
...
/* struct Item8Cell_Previews: PreviewProvider {
