...
struct ShoppingCartThirty3View: View {
    @StateObject var shoppingCartThirty3ViewModel = ShoppingCartThirty3ViewModel()
...
struct ShoppingCartThirty3View_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartThirty3View()
    }
}
