...
struct ShoppingCartThirtyFourView: View {
    @StateObject var shoppingCartThirtyFourViewModel = ShoppingCartThirtyFourViewModel()
...
struct ShoppingCartThirtyFourView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartThirtyFourView()
    }
}
