...
struct ShoppingCart9View: View {
    @StateObject var shoppingCart9ViewModel = ShoppingCart9ViewModel()
            ...
            VStack {
                VStack {
                    ScrollView(.vertical, showsIndicators: false) {
                        VStack(alignment: .trailing, spacing: 0) {
                            ...
                            VStack {
                                Button(action: {
                                    shoppingCart9ViewModel.nextScreen = "Assembly2View"
                                }, label: {
                                    HStack(spacing: 0) {
                            ...
                            .padding(.top, getRelativeHeight(210.0))
                            ...
                            HStack {
                                ...
                                .onTapGesture {
                                    shoppingCart9ViewModel.nextScreen = "BankappZeroView"
                                }
                ...
                Group {
                    NavigationLink(destination: Assembly2View(),
                                   tag: "Assembly2View",
                                   selection: $shoppingCart9ViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct ShoppingCart9View_Previews: PreviewProvider {
