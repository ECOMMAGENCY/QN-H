...
struct ShoppingCartThirtySevenView: View {
    @StateObject var shoppingCartThirtySevenViewModel = ShoppingCartThirtySevenViewModel()
...
struct ShoppingCartThirtySevenView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartThirtySevenView()
    }
}
