...
struct ShoppingCartFortyEightView: View {
    @StateObject var shoppingCartFortyEightViewModel = ShoppingCartFortyEightViewModel()
                ...
                ScrollView(.vertical, showsIndicators: false) {
                    VStack(alignment: .trailing, spacing: 0) {
                        ...
                        HStack {
                            ...
                            ZStack(alignment: .bottomLeading) {
                                Text(StringConstants.kMsgWindowShadeI)
                                    ...
                                    .padding(.leading, getRelativeWidth(12.11))
                                Text(StringConstants.kLbl6200)
                                    ...
                                    .padding(.top, getRelativeHeight(56.21))
                                    .padding(.trailing, getRelativeWidth(128.0))
                            }
                            .hideNavigationBar()
                            .frame(width: getRelativeWidth(181.0), height: getRelativeHeight(74.0),
                                   alignment: .top)
                        ...
                        HStack {
                            ...
                            .frame(width: getRelativeWidth(161.0), height: getRelativeHeight(43.0),
                                   alignment: .bottom)
                        ...
                        ScrollView(.horizontal, showsIndicators: false) {
                                ...
                                ZStack(alignment: .leading) {
                                    HStack {
                                        Text(StringConstants.kLbl89775)
                                            .font(FontScheme
                                                .kNumansRegular(size: getRelativeHeight(17.0)))
                                            .fontWeight(.regular)
                                            .foregroundColor(ColorConstants.WhiteA700)
                                            .minimumScaleFactor(0.5)
                                            .multilineTextAlignment(.leading)
                            ...
                            .hideNavigationBar()
                            .frame(width: UIScreen.main.bounds.width,
                                   height: getRelativeHeight(175.0), alignment: .leading)
                        }
...
struct ShoppingCartFortyEightView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartFortyEightView()
    }
}
