...
struct ShoppingCartFortyThreeView: View {
    @StateObject var shoppingCartFortyThreeViewModel = ShoppingCartFortyThreeViewModel()
                ...
                ScrollView(.vertical, showsIndicators: false) {
                    VStack(alignment: .trailing, spacing: 0) {
                        ...
                        HStack {
                            ...
                            .frame(width: getRelativeWidth(201.0), height: getRelativeHeight(58.0),
                                   alignment: .bottom)
...
struct ShoppingCartFortyThreeView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartFortyThreeView()
    }
}
