        ...
        HStack {
            ...
            VStack(alignment: .leading, spacing: 0) {
                Text(StringConstants.kMsgOfficeFurnitur)
                    ...
                    .frame(width: getRelativeWidth(147.0), height: getRelativeHeight(25.0),
                           alignment: .leading)
                    .padding(.leading, getRelativeWidth(4.0))
            ...
            .frame(width: getRelativeWidth(151.0), height: getRelativeHeight(61.0),
                   alignment: .leading)
...
/* struct Item14Cell_Previews: PreviewProvider {
