...
struct ShoppingCartTwentyEightView: View {
    @StateObject var shoppingCartTwentyEightViewModel = ShoppingCartTwentyEightViewModel()
...
struct ShoppingCartTwentyEightView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartTwentyEightView()
    }
}
