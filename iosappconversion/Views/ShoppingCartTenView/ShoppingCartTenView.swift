...
struct ShoppingCartTenView: View {
    @StateObject var shoppingCartTenViewModel = ShoppingCartTenViewModel()
            ...
            VStack {
                    ...
                    ScrollView(.vertical, showsIndicators: false) {
                        VStack(alignment: .trailing, spacing: 0) {
                            ...
                            HStack {
                                ...
                                .onTapGesture {
                                    shoppingCartTenViewModel.nextScreen = "BankappZeroView"
                                }
                ...
                Group {
                    NavigationLink(destination: Assembly2View(),
                                   tag: "Assembly2View",
                                   selection: $shoppingCartTenViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct ShoppingCartTenView_Previews: PreviewProvider {
