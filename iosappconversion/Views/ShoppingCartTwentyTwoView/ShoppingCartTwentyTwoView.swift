...
struct ShoppingCartTwentyTwoView: View {
    @StateObject var shoppingCartTwentyTwoViewModel = ShoppingCartTwentyTwoViewModel()
...
struct ShoppingCartTwentyTwoView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartTwentyTwoView()
    }
}
