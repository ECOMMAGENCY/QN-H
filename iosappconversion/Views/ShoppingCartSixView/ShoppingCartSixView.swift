...
struct ShoppingCartSixView: View {
    @StateObject var shoppingCartSixViewModel = ShoppingCartSixViewModel()
            ...
            VStack {
                    ...
                    ScrollView(.vertical, showsIndicators: false) {
                        VStack(alignment: .trailing, spacing: 0) {
                            ...
                            HStack {
                                ...
                                .onTapGesture {
                                    shoppingCartSixViewModel.nextScreen = "BankappZeroView"
                                }
                ...
                Group {
                    NavigationLink(destination: Assembly2View(),
                                   tag: "Assembly2View",
                                   selection: $shoppingCartSixViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct ShoppingCartSixView_Previews: PreviewProvider {
