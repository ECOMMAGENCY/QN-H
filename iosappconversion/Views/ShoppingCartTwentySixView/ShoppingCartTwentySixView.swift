...
struct ShoppingCartTwentySixView: View {
    @StateObject var shoppingCartTwentySixViewModel = ShoppingCartTwentySixViewModel()
...
struct ShoppingCartTwentySixView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartTwentySixView()
    }
}
