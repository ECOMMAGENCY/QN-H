...
struct AssemblyblendOneView: View {
    @StateObject var assemblyblendOneViewModel = AssemblyblendOneViewModel()
    ...
    var body: some View {
        NavigationView {
            VStack {
                    ...
                    HStack {
                        HStack {
                            ...
                            Image("img_iconoutline")
                                ...
                                .clipped()
                                .onTapGesture {
                                    assemblyblendOneViewModel.nextScreen = "AllCategoriesView"
                                }
                            Spacer()
                            Image("img_icon24pxnotif")
                                ...
                                .clipped()
                                .onTapGesture {
                                    assemblyblendOneViewModel.nextScreen = "NotificationEmptyView"
                                }
                        }
                                        ...
                                        VStack(alignment: .leading, spacing: 0) {
                                            Image("img_interiorpainti_13")
                                                ...
                                                .background(RoundedCorners(topLeft: 36.0,
                                                                           ...
                                                                           bottomRight: 36.0))
                                                .onTapGesture {
                                                    assemblyblendOneViewModel
                                                        .nextScreen = "ShoppingCartNineView"
                                                }
                                    ...
                                    VStack {
                                        LazyVGrid(columns: [SwiftUI.GridItem(), SwiftUI.GridItem(),
                                            ...
                                            ForEach(0 ... 5, id: \.self) { index in
                                                Columninteriorpaintithree1Cell()
                                            }
                                        }
                                    }
                                }
                ...
                Group {
                    NavigationLink(destination: ShoppingCartNineView(),
                                   tag: "ShoppingCartNineView",
                                   selection: $assemblyblendOneViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct AssemblyblendOneView_Previews: PreviewProvider {
    static var previews: some View {
        AssemblyblendOneView()
    }
}
