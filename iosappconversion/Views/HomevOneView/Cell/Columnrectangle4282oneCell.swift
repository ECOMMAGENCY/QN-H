...
struct Columnrectangle4282oneCell: View {
    var body: some View {
        ZStack(alignment: .bottom) {
            VStack(alignment: .leading, spacing: 0) {
                ...
                .hideNavigationBar()
                .frame(width: getRelativeWidth(136.0), height: getRelativeHeight(154.0),
                       alignment: .leading)
                Text(StringConstants.kMsgGeneralHandyma)
                    ...
                    .frame(width: getRelativeWidth(135.0), height: getRelativeHeight(19.0),
                           alignment: .leading)
                    .padding(.top, getRelativeHeight(15.0))
            }
            .frame(width: getRelativeWidth(136.0), alignment: .leading)
        }
        .hideNavigationBar()
    }
}

/* struct Columnrectangle4282oneCell_Previews: PreviewProvider {
