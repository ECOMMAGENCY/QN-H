...
struct ShoppingCartEighteenView: View {
    @StateObject var shoppingCartEighteenViewModel = ShoppingCartEighteenViewModel()
            ...
            ZStack {
                ScrollView(.vertical, showsIndicators: false) {
                    VStack(alignment: .trailing, spacing: 0) {
                        ...
                        .padding(.top, getRelativeHeight(324.0))
                        .padding(.trailing, getRelativeWidth(15.0))
                        HStack {
...
struct ShoppingCartEighteenView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartEighteenView()
    }
}
