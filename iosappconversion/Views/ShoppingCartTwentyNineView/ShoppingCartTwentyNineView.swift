...
struct ShoppingCartTwentyNineView: View {
    @StateObject var shoppingCartTwentyNineViewModel = ShoppingCartTwentyNineViewModel()
                ...
                ScrollView(.vertical, showsIndicators: false) {
                    VStack(alignment: .trailing, spacing: 0) {
                        ...
                        HStack {
                            ...
                            .hideNavigationBar()
                            .frame(width: getRelativeWidth(153.0), height: getRelativeHeight(73.0),
                                   alignment: .top)
...
struct ShoppingCartTwentyNineView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartTwentyNineView()
    }
}
