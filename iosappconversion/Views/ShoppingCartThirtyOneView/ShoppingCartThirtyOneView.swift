...
struct ShoppingCartThirtyOneView: View {
    @StateObject var shoppingCartThirtyOneViewModel = ShoppingCartThirtyOneViewModel()
            ...
            ZStack {
                ScrollView(.vertical, showsIndicators: false) {
                    VStack(alignment: .trailing, spacing: 0) {
                        ...
                        .frame(width: getRelativeWidth(346.0), alignment: .center)
...
struct ShoppingCartThirtyOneView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartThirtyOneView()
    }
}
