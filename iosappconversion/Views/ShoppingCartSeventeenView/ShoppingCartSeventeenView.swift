...
struct ShoppingCartSeventeenView: View {
    @StateObject var shoppingCartSeventeenViewModel = ShoppingCartSeventeenViewModel()
                    ...
                    VStack(alignment: .trailing, spacing: 0) {
                        ...
                        HStack {
                            ...
                            VStack(alignment: .leading, spacing: 0) {
                                Text(StringConstants.kMsgOfficeFurnitur)
                            ...
                            .frame(width: getRelativeWidth(153.0), height: getRelativeHeight(61.0),
                                   alignment: .bottom)
                        ...
                        HStack {
                            ...
                            .frame(width: getRelativeWidth(127.0), height: getRelativeHeight(24.0),
                                   alignment: .top)
...
struct ShoppingCartSeventeenView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartSeventeenView()
    }
}
