...
struct ShoppingCartOneView: View {
    @StateObject var shoppingCartOneViewModel = ShoppingCartOneViewModel()
            ...
            VStack {
                VStack {
                    ScrollView(.vertical, showsIndicators: false) {
                        VStack(alignment: .trailing, spacing: 0) {
                            VStack(alignment: .trailing, spacing: 0) {
                                ...
                                HStack {
                                    ...
                                    Image("img_bin")
                                        ...
                                        .onTapGesture {
                                            shoppingCartOneViewModel.nextScreen = "Assembly2View"
                                        }
                                    Spacer()
                                }
                            ...
                            VStack {
                                Button(action: {
                                    shoppingCartOneViewModel.nextScreen = "AssemblyblendOneView"
                                }, label: {
                                    HStack(spacing: 0) {
                            ...
                            HStack {
                                ...
                                .onTapGesture {
                                    shoppingCartOneViewModel.nextScreen = "BankappZeroView"
                                }
                ...
                Group {
                    NavigationLink(destination: Assembly2View(),
                                   tag: "Assembly2View",
                                   selection: $shoppingCartOneViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                    NavigationLink(destination: AssemblyblendOneView(),
                                   tag: "AssemblyblendOneView",
                                   selection: $shoppingCartOneViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct ShoppingCartOneView_Previews: PreviewProvider {
