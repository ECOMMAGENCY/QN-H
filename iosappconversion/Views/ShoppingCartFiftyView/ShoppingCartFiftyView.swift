...
struct ShoppingCartFiftyView: View {
    @StateObject var shoppingCartFiftyViewModel = ShoppingCartFiftyViewModel()
                ...
                ScrollView(.vertical, showsIndicators: false) {
                    VStack(alignment: .trailing, spacing: 0) {
                        VStack(alignment: .trailing, spacing: 0) {
                            ...
                            .padding(.leading)
                            HStack {
                                Image("img_interiorpainti_73x114")
                                    .resizable()
                                ...
                                Text(StringConstants.kMsgSameDayClean)
...
struct ShoppingCartFiftyView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartFiftyView()
    }
}
