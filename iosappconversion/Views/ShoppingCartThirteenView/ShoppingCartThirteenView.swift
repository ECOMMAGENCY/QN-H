...
struct ShoppingCartThirteenView: View {
    @StateObject var shoppingCartThirteenViewModel = ShoppingCartThirteenViewModel()
                ...
                ScrollView(.vertical, showsIndicators: false) {
                    VStack(alignment: .trailing, spacing: 0) {
                        ...
                        HStack {
                            ...
                            .frame(width: getRelativeWidth(189.0), height: getRelativeHeight(53.0),
                                   alignment: .bottom)
...
struct ShoppingCartThirteenView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartThirteenView()
    }
}
