...
struct ShoppingCartFortyFiveView: View {
    @StateObject var shoppingCartFortyFiveViewModel = ShoppingCartFortyFiveViewModel()
...
struct ShoppingCartFortyFiveView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartFortyFiveView()
    }
}
