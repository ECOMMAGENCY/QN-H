...
struct ShoppingCartTwoView: View {
    @StateObject var shoppingCartTwoViewModel = ShoppingCartTwoViewModel()
            ...
            VStack {
                        ...
                        VStack(alignment: .trailing, spacing: 0) {
                            ...
                            HStack {
                                ...
                                Image("img_bin")
                                    ...
                                    .onTapGesture {
                                        shoppingCartTwoViewModel.nextScreen = "Assembly2View"
                                    }
                                Spacer()
                            }
                            ...
                            HStack {
                                ...
                                .onTapGesture {
                                    shoppingCartTwoViewModel.nextScreen = "BankappZeroView"
                                }
                ...
                Group {
                    NavigationLink(destination: BankappZeroView(),
                                   tag: "BankappZeroView",
                                   selection: $shoppingCartTwoViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct ShoppingCartTwoView_Previews: PreviewProvider {
