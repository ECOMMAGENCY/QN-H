...
struct ShoppingCartFortyOneView: View {
    @StateObject var shoppingCartFortyOneViewModel = ShoppingCartFortyOneViewModel()
                    ...
                    VStack(alignment: .trailing, spacing: 0) {
                        VStack(alignment: .trailing, spacing: 0) {
                            ...
                            HStack {
                                ...
                                Spacer()
                                Text(StringConstants.kMsgHomeSanitizat)
...
struct ShoppingCartFortyOneView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartFortyOneView()
    }
}
