...
struct ShoppingCartFourteenView: View {
    @StateObject var shoppingCartFourteenViewModel = ShoppingCartFourteenViewModel()
...
struct ShoppingCartFourteenView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartFourteenView()
    }
}
