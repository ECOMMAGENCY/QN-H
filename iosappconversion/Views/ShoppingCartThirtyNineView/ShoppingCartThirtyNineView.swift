...
struct ShoppingCartThirtyNineView: View {
    @StateObject var shoppingCartThirtyNineViewModel = ShoppingCartThirtyNineViewModel()
...
struct ShoppingCartThirtyNineView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartThirtyNineView()
    }
}
