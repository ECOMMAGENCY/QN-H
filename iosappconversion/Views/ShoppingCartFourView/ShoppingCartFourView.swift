...
struct ShoppingCartFourView: View {
    @StateObject var shoppingCartFourViewModel = ShoppingCartFourViewModel()
            ...
            VStack {
                    ...
                    ScrollView(.vertical, showsIndicators: false) {
                        VStack(alignment: .trailing, spacing: 0) {
                            ...
                            HStack {
                                ...
                                .onTapGesture {
                                    shoppingCartFourViewModel.nextScreen = "BankappZeroView"
                                }
                ...
                Group {
                    NavigationLink(destination: BankappZeroView(),
                                   tag: "BankappZeroView",
                                   selection: $shoppingCartFourViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct ShoppingCartFourView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartFourView()
    }
}
