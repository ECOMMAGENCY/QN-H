...
struct ShoppingCartForty3View: View {
    @StateObject var shoppingCartForty3ViewModel = ShoppingCartForty3ViewModel()
                        ...
                        VStack(alignment: .trailing, spacing: 0) {
                            ...
                            ZStack(alignment: .bottomTrailing) {
                                ...
                                Text(StringConstants.kMsgHangingPictur)
                                    ...
                                    .padding(.top, getRelativeHeight(5.62))
                                    .padding(.leading, getRelativeWidth(202.93))
                            }
                            .hideNavigationBar()
...
struct ShoppingCartForty3View_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartForty3View()
    }
}
