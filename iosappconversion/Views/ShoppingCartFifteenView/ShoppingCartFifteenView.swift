...
struct ShoppingCartFifteenView: View {
    @StateObject var shoppingCartFifteenViewModel = ShoppingCartFifteenViewModel()
...
struct ShoppingCartFifteenView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartFifteenView()
    }
}
