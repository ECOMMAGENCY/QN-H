...
struct ShoppingCartTwelveView: View {
    @StateObject var shoppingCartTwelveViewModel = ShoppingCartTwelveViewModel()
            ...
            VStack {
                VStack {
                    ScrollView(.vertical, showsIndicators: false) {
                        VStack(alignment: .trailing, spacing: 0) {
                            ...
                            .frame(width: getRelativeWidth(346.0), height: getRelativeHeight(214.0),
                                   alignment: .center)
                            .padding(.horizontal, getRelativeWidth(13.0))
                            VStack {
                                Button(action: {
                                    shoppingCartTwelveViewModel.nextScreen = "HomecleaningOneView"
                                }, label: {
                                    HStack(spacing: 0) {
                            ...
                            HStack {
                                ...
                                .onTapGesture {
                                    shoppingCartTwelveViewModel.nextScreen = "BankappZeroView"
                                }
                ...
                Group {
                    NavigationLink(destination: HomecleaningOneView(),
                                   ...
                                   selection: $shoppingCartTwelveViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct ShoppingCartTwelveView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartTwelveView()
    }
}
