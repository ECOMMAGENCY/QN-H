...
struct ShoppingCartFortyTwoView: View {
    @StateObject var shoppingCartFortyTwoViewModel = ShoppingCartFortyTwoViewModel()
...
struct ShoppingCartFortyTwoView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartFortyTwoView()
    }
}
