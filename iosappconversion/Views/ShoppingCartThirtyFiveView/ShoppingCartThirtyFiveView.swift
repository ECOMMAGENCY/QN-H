...
struct ShoppingCartThirtyFiveView: View {
    @StateObject var shoppingCartThirtyFiveViewModel = ShoppingCartThirtyFiveViewModel()
                    ...
                    VStack(alignment: .trailing, spacing: 0) {
                        ...
                        HStack {
                            HStack {
                                ...
                                .frame(width: getRelativeWidth(137.0),
                                       height: getRelativeHeight(62.0), alignment: .bottom)
...
struct ShoppingCartThirtyFiveView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartThirtyFiveView()
    }
}
