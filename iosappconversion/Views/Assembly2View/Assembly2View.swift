...
struct Assembly2View: View {
    @StateObject var assembly2ViewModel = Assembly2ViewModel()
            ...
            VStack {
                    ...
                    HStack {
                        HStack {
                            ...
                            Image("img_iconoutline")
                                ...
                                .clipped()
                                .onTapGesture {
                                    assembly2ViewModel.nextScreen = "AllCategoriesView"
                                }
                            Spacer()
                            Image("img_icon24pxnotif")
                                ...
                                .clipped()
                                .onTapGesture {
                                    assembly2ViewModel.nextScreen = "NotificationEmptyView"
                                }
                        }
                                    ...
                                    HStack {
                                        VStack(alignment: .leading, spacing: 0) {
                                            Image("img_interiorpainti_13")
                                                ...
                                                .onTapGesture {
                                                    assembly2ViewModel
                                                        .nextScreen = "ShoppingCartTwoView"
                                                }
                ...
                Group {
                    NavigationLink(destination: AllCategoriesView(),
                                   ...
                                   selection: $assembly2ViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                    ...
                    NavigationLink(destination: ShoppingCartTwoView(),
                                   tag: "ShoppingCartTwoView",
                                   selection: $assembly2ViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct Assembly2View_Previews: PreviewProvider {
