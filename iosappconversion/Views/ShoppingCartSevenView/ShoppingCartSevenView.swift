...
struct ShoppingCartSevenView: View {
    @StateObject var shoppingCartSevenViewModel = ShoppingCartSevenViewModel()
            ...
            VStack {
                    ...
                    ScrollView(.vertical, showsIndicators: false) {
                        VStack(alignment: .trailing, spacing: 0) {
                                ...
                                ScrollView(.vertical, showsIndicators: false) {
                                    LazyVStack {
                                        ForEach(0 ... 1, id: \.self) { index in
                                            RowinteriorpaintioneCell(binoneClick: {
                                                shoppingCartSevenViewModel
                                                    .nextScreen = "HomecleaningTwoView"
                                            })
                                        }
                            ...
                            HStack {
                                ...
                                .onTapGesture {
                                    shoppingCartSevenViewModel.nextScreen = "BankappZeroView"
                                }
                ...
                Group {
                    NavigationLink(destination: HomecleaningTwoView(),
                                   ...
                                   selection: $shoppingCartSevenViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct ShoppingCartSevenView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartSevenView()
    }
}
