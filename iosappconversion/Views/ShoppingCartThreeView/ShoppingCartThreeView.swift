...
struct ShoppingCartThreeView: View {
    @StateObject var shoppingCartThreeViewModel = ShoppingCartThreeViewModel()
            ...
            VStack {
                        ...
                        VStack(alignment: .trailing, spacing: 0) {
                            VStack(alignment: .trailing, spacing: 0) {
                                HStack {
                                    ...
                                    HStack {
                                        ...
                                        Text(StringConstants.kLbl3)
                                            .font(FontScheme.kNTR(size: getRelativeHeight(16.0)))
                                            .fontWeight(.regular)
                                ...
                                .frame(width: getRelativeWidth(217.0),
                                       height: getRelativeHeight(54.0), alignment: .trailing)
                                .padding(.leading)
                                .padding(.leading)
                                HStack {
                                    ...
                                    Image("img_bin")
                                        ...
                                        .onTapGesture {
                                            shoppingCartThreeViewModel
                                                .nextScreen = "HomecleaningTwoView"
                                        }
                                }
                            ...
                            .frame(width: getRelativeWidth(342.0), height: getRelativeHeight(214.0),
                                   alignment: .center)
                                ...
                                ScrollView(.vertical, showsIndicators: false) {
                                    LazyVStack {
                                        ForEach(0 ... 1, id: \.self) { index in
                                            Rowinteriorpaintione1Cell(binoneClick: {
                                                shoppingCartThreeViewModel
                                                    .nextScreen = "HomecleaningTwoView"
                                            })
                                        }
                            ...
                            .padding(.trailing, getRelativeWidth(15.0))
                            HStack {
                                Text(StringConstants.kLbl11400)
                                ...
                                .onTapGesture {
                                    shoppingCartThreeViewModel.nextScreen = "BankappZeroView"
                                }
                ...
                Group {
                    NavigationLink(destination: HomecleaningTwoView(),
                                   ...
                                   selection: $shoppingCartThreeViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct ShoppingCartThreeView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartThreeView()
    }
}
