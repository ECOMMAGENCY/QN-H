...
struct ShoppingCartTwentyFiveView: View {
    @StateObject var shoppingCartTwentyFiveViewModel = ShoppingCartTwentyFiveViewModel()
                ...
                ScrollView(.vertical, showsIndicators: false) {
                    VStack(alignment: .trailing, spacing: 0) {
                        ...
                        HStack {
                            ...
                            .hideNavigationBar()
                            .frame(width: getRelativeWidth(174.0), height: getRelativeHeight(71.0),
                                   alignment: .top)
...
struct ShoppingCartTwentyFiveView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartTwentyFiveView()
    }
}
