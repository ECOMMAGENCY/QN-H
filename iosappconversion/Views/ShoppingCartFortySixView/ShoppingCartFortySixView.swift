...
struct ShoppingCartFortySixView: View {
    @StateObject var shoppingCartFortySixViewModel = ShoppingCartFortySixViewModel()
...
struct ShoppingCartFortySixView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartFortySixView()
    }
}
