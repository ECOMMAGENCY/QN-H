...
struct ShoppingCartThirtyEightView: View {
    @StateObject var shoppingCartThirtyEightViewModel = ShoppingCartThirtyEightViewModel()
                ...
                ScrollView(.vertical, showsIndicators: false) {
                    VStack(alignment: .trailing, spacing: 0) {
                        ...
                        HStack {
                            ...
                            .frame(width: getRelativeWidth(181.0), height: getRelativeHeight(51.0),
                                   alignment: .bottom)
...
struct ShoppingCartThirtyEightView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartThirtyEightView()
    }
}
