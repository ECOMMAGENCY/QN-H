...
struct ShoppingCartFortyFourView: View {
    @StateObject var shoppingCartFortyFourViewModel = ShoppingCartFortyFourViewModel()
...
struct ShoppingCartFortyFourView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartFortyFourView()
    }
}
