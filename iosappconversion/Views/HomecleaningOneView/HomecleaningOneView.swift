...
struct HomecleaningOneView: View {
    @StateObject var homecleaningOneViewModel = HomecleaningOneViewModel()
            ...
            VStack {
                    ...
                    HStack {
                        HStack {
                            ...
                            Image("img_iconoutline")
                                ...
                                .clipped()
                                .onTapGesture {
                                    homecleaningOneViewModel.nextScreen = "AllCategoriesView"
                                }
                            Spacer()
                            Image("img_icon24pxnotif")
                                ...
                                .clipped()
                                .onTapGesture {
                                    homecleaningOneViewModel.nextScreen = "NotificationEmptyView"
                                }
                        }
                                ...
                                ScrollView(.vertical, showsIndicators: false) {
                                    LazyVStack {
                                        ForEach(0 ... 1, id: \.self) { index in
                                            NdRow1Cell(interiorpaintioneClick: {
                                                homecleaningOneViewModel
                                                    .nextScreen = "ShoppingCartEightView"
                                            })
                                        }
                                    }
                                }
                ...
                Group {
                    NavigationLink(destination: AllCategoriesView(),
                                   ...
                                   selection: $homecleaningOneViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                    ...
                    NavigationLink(destination: ShoppingCartEightView(),
                                   tag: "ShoppingCartEightView",
                                   selection: $homecleaningOneViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct HomecleaningOneView_Previews: PreviewProvider {
