...
struct ShoppingCartElevenView: View {
    @StateObject var shoppingCartElevenViewModel = ShoppingCartElevenViewModel()
            ...
            VStack {
                VStack {
                    ScrollView(.vertical, showsIndicators: false) {
                        VStack(alignment: .trailing, spacing: 0) {
                            VStack(alignment: .trailing, spacing: 0) {
                                ...
                                HStack {
                                    ...
                                    Image("img_bin")
                                        ...
                                        .onTapGesture {
                                            shoppingCartElevenViewModel
                                                .nextScreen = "AssemblyblendView"
                                        }
                                    Spacer()
                                }
                            ...
                            .padding(.trailing, getRelativeWidth(15.0))
                            HStack {
                                Text(StringConstants.kLbl18600)
                                ...
                                .onTapGesture {
                                    shoppingCartElevenViewModel.nextScreen = "BankappZeroView"
                                }
                ...
                Group {
                    NavigationLink(destination: AssemblyblendView(),
                                   ...
                                   selection: $shoppingCartElevenViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct ShoppingCartElevenView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartElevenView()
    }
}
