...
struct ShoppingCartThirtyThreeView: View {
    @StateObject var shoppingCartThirtyThreeViewModel = ShoppingCartThirtyThreeViewModel()
...
struct ShoppingCartThirtyThreeView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartThirtyThreeView()
    }
}
