...
struct ShoppingCartFiftyOneView: View {
    @StateObject var shoppingCartFiftyOneViewModel = ShoppingCartFiftyOneViewModel()
...
struct ShoppingCartFiftyOneView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartFiftyOneView()
    }
}
