...
struct ShoppingCartFortySevenView: View {
    @StateObject var shoppingCartFortySevenViewModel = ShoppingCartFortySevenViewModel()
...
struct ShoppingCartFortySevenView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartFortySevenView()
    }
}
