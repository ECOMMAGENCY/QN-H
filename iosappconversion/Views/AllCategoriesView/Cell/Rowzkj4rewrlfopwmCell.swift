...
struct Rowzkj4rewrlfopwmCell: View {
    var body: some View {
        HStack {
            ZStack {
                Image("img_zkj4rewrlfopwm")
                    .resizable()
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                Text(StringConstants.kLblAssembly)
                    ...
                    .minimumScaleFactor(0.5)
                    .multilineTextAlignment(.leading)
                    .frame(width: getRelativeWidth(64.0), height: getRelativeHeight(17.0),
                           alignment: .leading)
                ...
                Button(action: {}, label: {
                    HStack(spacing: 0) {
                        Text(StringConstants.kLbl52)
                            ...
                            .frame(width: getRelativeWidth(33.0), height: getRelativeHeight(24.0),
                                   alignment: .center)
...
/* struct Rowzkj4rewrlfopwmCell_Previews: PreviewProvider {
