...
struct ShoppingCartTwentyOneView: View {
    @StateObject var shoppingCartTwentyOneViewModel = ShoppingCartTwentyOneViewModel()
                ...
                ScrollView(.vertical, showsIndicators: false) {
                    VStack(alignment: .trailing, spacing: 0) {
                        ...
                        HStack {
                            ...
                            Spacer()
                            VStack {
                                Text(StringConstants.kMsgOutdoorFurnitu)
                            ...
                            .frame(width: getRelativeWidth(169.0), height: getRelativeHeight(61.0),
                                   alignment: .bottom)
...
struct ShoppingCartTwentyOneView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartTwentyOneView()
    }
}
