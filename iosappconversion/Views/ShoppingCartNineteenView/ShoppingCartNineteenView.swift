...
struct ShoppingCartNineteenView: View {
    @StateObject var shoppingCartNineteenViewModel = ShoppingCartNineteenViewModel()
...
struct ShoppingCartNineteenView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartNineteenView()
    }
}
