...
struct ShoppingCartTwentyThreeView: View {
    @StateObject var shoppingCartTwentyThreeViewModel = ShoppingCartTwentyThreeViewModel()
            ...
            ZStack {
                ScrollView(.vertical, showsIndicators: false) {
                    VStack(alignment: .trailing, spacing: 0) {
                        ...
                        .frame(width: getRelativeWidth(348.0), alignment: .center)
...
struct ShoppingCartTwentyThreeView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingCartTwentyThreeView()
    }
}
