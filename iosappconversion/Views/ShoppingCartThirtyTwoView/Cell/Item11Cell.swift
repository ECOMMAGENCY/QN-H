        ...
        HStack {
            ...
            VStack {
                Text(StringConstants.kLblBedAssembly)
                    ...
                    .frame(width: getRelativeWidth(134.0), height: getRelativeHeight(25.0),
                           alignment: .leading)
            ...
            .frame(width: getRelativeWidth(144.0), height: getRelativeHeight(59.0),
                   alignment: .leading)
...
/* struct Item11Cell_Previews: PreviewProvider {
